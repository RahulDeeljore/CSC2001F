...
* The number of comparisons made when inserting a particular object is stored as the "insertcount" variable of the Dam object
...
{
Bst.insert(i);
i.insertcount = BinarySearchTree.InsertCount;
...
System.out.println("search counts:"+makeBST().returnCount());
BinarySearchTree.resetc();
}
}
